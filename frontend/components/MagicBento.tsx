...
const DEFAULT_GLOW_COLOR = '95, 166, 166'; // Cool Teal from palette
    ...
    return (
        <>
          ...
          .bento-section {
            ...
            --background-dark: var(--color-soft-gold);
            --card-text: var(--color-matte-black);
          }
          
          .dark .bento-section {
            --background-dark: #3B3B3B;
            --card-text: var(--color-light-cream);
          }
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(139, 0, 0, 0.3), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(139, 0, 0, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid gap-2">
                    {cards.map((card, index) => {
                        ...
                        const cardStyle = {
                            background: 'linear-gradient(135deg, var(--color-surface) 50%, var(--color-border) 50%)',
                            ...
                            '--glow-intensity': '0',
                            '--glow-radius': '200px',
                            '--glow-color': 'var(--color-secondary)' // Cool Teal for hover
